						...
						<div class="col-sm-12">
								...
								<div class="blog blog-single-post">
									<div class="blog-image">
										<a href="javascript:void(0);"><img alt="" src="../assets_admin/img/blog/blog-01.jpg" class="img-fluid"></a>
									</div>
											...
											<ul>
												<li>
													<div class="post-author">
														<a href="doctor-profile"><img src="../assets_admin/img/doctors/doctor-thumb-02.jpg" alt="Post Author"> <span>Dr. Darren Elder</span></a>
													</div>
												</li>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="doctor-profile"><img class="img-fluid rounded-circle" alt="" src="../assets_admin/img/doctors/doctor-thumb-02.jpg"></a>
											</div>
										</div>
								...
								<div class="card blog-comments clearfix">
									...
									<ul class="comments-list">
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="../assets_admin/img/patients/patient4.jpg">
												</div>
											...
											<ul class="comments-list reply">
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="" src="../assets_admin/img/patients/patient5.jpg">
														</div>
														<div class="comment-block">
															<span class="comment-by">
												...
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="" src="../assets_admin/img/patients/patient3.jpg">
														</div>
														<div class="comment-block">
															<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="../assets_admin/img/patients/patient6.jpg">
												</div>
												<div class="comment-block">
													<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="../assets_admin/img/patients/patient7.jpg">
												</div>
												<div class="comment-block">
													<span class="comment-by">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doccure_laravel\template\resources\views/admin/blog-details.blade.php ENDPATH**/ ?>