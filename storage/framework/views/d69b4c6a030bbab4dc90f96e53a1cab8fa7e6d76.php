									...
									<div class="doctor-widget">
										...
										<div class="doc-info-right">
											<div class="clinic-booking">
												<a class="view-pro-btn" href="pharmacy-details">View Details</a>
												<a class="apt-btn" href="product-all">Browse Products</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									<div class="doctor-widget">
										<div class="doc-info-left">
											...
											<div class="doc-info-cont">
												<h4 class="doc-name mb-2"><a href="pharmacy-details">PharmaMed Medical</a></h4>
												<div class="rating mb-2">
													<span class="badge badge-primary">4.0</span>
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
								...
								<div class="card-body">
									<div class="doctor-widget">
										<div class="doc-info-left">
											...
											<div class="doc-info-cont">
												<h4 class="doc-name mb-2"><a href="pharmacy-details">The Pill Club Medical</a></h4>
												<div class="rating mb-2">
													<span class="badge badge-primary">4.0</span>
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doccure_laravel\template\resources\views/pharmacy-search.blade.php ENDPATH**/ ?>