					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<!-- Add Medicine -->
								<form method="post" enctype="multipart/form-data" autocomplete="off" id="update_service" action="medicine">
...
<?php echo $__env->make('layout.mainlayout_pharmacy_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doccure_laravel\template\resources\views/pharmacy-admin/edit-product.blade.php ENDPATH**/ ?>