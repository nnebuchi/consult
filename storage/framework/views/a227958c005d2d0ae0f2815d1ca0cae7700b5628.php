								...
								<table class="table table-hover table-center mb-0">
									...
									<tbody>
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product.jpg" alt="User Image"></a>
												</h2>
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product1.jpg" alt="User Image"></a>
												</h2>
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product2.jpg" alt="User Image"></a>
												</h2>
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product3.jpg" alt="User Image"></a>
												</h2>
										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="product-description" class="avatar avatar-sm mr-2"><img class="avatar-img" src="assets/img/products/product4.jpg" alt="User Image"></a>
												</h2>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doccure_laravel\template\resources\views/cart.blade.php ENDPATH**/ ?>