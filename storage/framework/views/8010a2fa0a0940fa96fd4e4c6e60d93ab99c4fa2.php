				...
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<li class="has-submenu">
								...
								<ul class="submenu">
									<li><a href="<?php echo e(route('pagee')); ?>" target="_blank">Admin</a></li>
									<li><a href="<?php echo e(route('pagees')); ?>" target="_blank">Pharmacy Admin</a></li>
								</ul>
							</li>
						<!-- <li>
					...
					<ul class="nav header-navbar-rht">
						...
						<?php if(Route::is(['chat','patient-dashboard','favourites','video-call','profile-settings','change-password','voice-call'])): ?>
