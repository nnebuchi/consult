<meta charset="utf-8">
		...
		@endif
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets_pharmacy/img/favicon.png')}}">
		<!-- Bootstrap CSS -->
        <link rel="stylesheet" href="{{asset('assets_pharmacy/css/bootstrap.min.css')}}">
		
		<!-- Fontawesome CSS -->
        <link rel="stylesheet" href="{{asset('assets_pharmacy/css/font-awesome.min.css')}}">
        <!-- <link rel="stylesheet" href="{{asset('assets_pharmacy/plugins/fontawesome/css/font-awesome.min.css')}}"> -->
        
        <link rel="stylesheet" href="{{asset('assets_pharmacy/plugins/fontawesome/css/all.min.css')}}">
		
		<!-- Feathericon CSS -->
        <link rel="stylesheet" href="{{asset('assets_pharmacy/css/feathericon.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets_pharmacy/plugins/morris/morris.css')}}">
        <!-- Select2 CSS -->
		<link rel="stylesheet" href="{{asset('assets_pharmacy/css/select2.min.css')}}">
        	<!-- Datetimepicker CSS -->
		<link rel="stylesheet" href="{{asset('assets_pharmacy/css/bootstrap-datetimepicker.min.css')}}">
		
		<!-- Full Calander CSS -->
        <link rel="stylesheet" href="{{asset('assets_pharmacy/plugins/fullcalendar/fullcalendar.min.css')}}">
        <!-- Datatables CSS -->
		<link rel="stylesheet" href="{{asset('assets_pharmacy/plugins/datatables/datatables.min.css')}}">
		
		<!-- <link rel="stylesheet" href="assets/plugins/morris/morris.css"> -->
		
		<!-- Main CSS -->
        <link rel="stylesheet" href="{{asset('assets_pharmacy/css/style.css')}}">